...
class ServerSelection:
        ...
        .get_attribute('innerHTML') == "Continue playing":
            if self.__IsServerCountMoreThanOne(self.__allActiveWorlds):
                if self.__firstWorld:
                    world_name = serverElement.find_element(By.CLASS_NAME, "game-world-name") \
                    .find_element(By.TAG_NAME, "span") \
                    ...
                    world_name = serverElement \
                    .find_element(By.CLASS_NAME, "game-world-name") \
                    .get_attribute("innerHTML")
                    self.__allServers[world_name] = serverElement
            else:
                world_name = serverElement \
    ...
    def __loginToTheSelectedWorld(self):
        self.__wait \
        .until(EC.element_to_be_clickable((self.__selectedWorld[1]
                                           .find_element(By.CSS_SELECTOR, "div.default-button")))) \
        .click()
        time.sleep(5)
